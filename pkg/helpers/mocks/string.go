...
// GenerateRandomCode provides a mock function with given fields: length
func (_m *KeyGenerator) GenerateRandomCode(length int) string {
	ret := _m.Called(length)

	if len(ret) == 0 {
		panic("no return value specified for GenerateRandomCode")
	}
